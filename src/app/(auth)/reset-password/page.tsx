...
//   // Helper component for displaying error messages - Adjusted for block display
...
//           <p className="text-gray-600 text-center mb-8 text-sm">Enter your new password</p>
...
//                 className="pr-10 rounded-full bg-yellow-50/50 border-yellow-200" // Styled as per UI
//               />
//               <button
//                 type="button"
...
//             <button
//               type="submit"
//               className="w-full py-3 rounded-full text-white font-semibold bg-blue-800 hover:bg-blue-900 shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-0.5"
//             >
//               Confirm
//             </button>
